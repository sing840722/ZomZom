...
void COpenAssetImportMesh::ClearModelData()
{
...
void COpenAssetImportMesh::SetPosition(glm::vec3 &position) {
	m_position = position;
}

glm::vec3 & const COpenAssetImportMesh::GetPosition() {
	return m_position;
}

glm::mat4 & const COpenAssetImportMesh::GetOrientationMatrix() {
	return m_matrix;
}

void COpenAssetImportMesh::SetOrientationMatrix(glm::mat4 &mat) {
	m_matrix = mat;
}